...
## Project Structure
    ...
    ├── throbbing_poetry_39002  # Django project configurations
...
1. Clone this repo and `cd throbbing_poetry_39002`
...
2. Clone this repo and `cd throbbing_poetry_39002`
